...
public class Grafico1 extends JPanel {
     ...
     * @param : dato de tipo ArbolExpresion que contiene el Arbol a
     * dibujar.
     */
    public Grafico1 (Arbol miArbol) {
    ...
    private Dimension calcularTamañoSubarbol(Nodo n)
    {
        ...
        Dimension ld = calcularTamañoSubarbol(n.izquierda);
        Dimension rd = calcularTamañoSubarbol(n.derecha);
